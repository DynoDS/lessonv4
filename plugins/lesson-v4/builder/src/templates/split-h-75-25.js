...
function drawSplitH7525(pptx, slide, data, ctx) {
  ...
  if (side === 'left') {
    ...
    secondaryZone = { x: bz.x + primaryW + GAP_X,     y: bz.y, w: secondaryW, h: bz.h, class: 'G'      };
  } else {
    secondaryZone = { x: bz.x,                        y: bz.y, w: secondaryW, h: bz.h, class: 'G'      };
