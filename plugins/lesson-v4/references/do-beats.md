...
| Predict | Commits to what will happen before seeing it, from a taught relationship | Science: which bulb will be brighter. Geography: where water from this branch of the river can go. | The taught relationship decides the answer and nothing on the board gives it away; otherwise it is a guess. |
...
| Repair | Fixes the fault in a way the taught idea justifies | Science: redraw the circuit so the lamp lights. English: replace a detail so the phrase suits a new atmosphere. | The repair follows from the diagnosis and is not the only visible option. |
