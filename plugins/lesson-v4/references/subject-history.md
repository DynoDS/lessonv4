...
5. **The limit of a source arrives as a question children can now answer.** But this is one school's timetable. Does that mean every Victorian child went to school on Saturday? No. Exactly: a source tells us about the person, place or school it came from, so we are careful before we say everyone lived like that. The idea the lesson is built to land, that one source is not a picture of everyone, is taught here, once, where children can see why it matters, and it is tested once more at the end.
...
## Talk and sort before anything is written

Writing is a named weakness in primary history, and the answer is not more writing. It is better-prepared writing. So the practice runs argue, sort, then write one paragraph, and the first two are where the thinking happens.

**Sort the evidence physically.** Causes, factors or events on cards, arranged by how much they matter to the question, with a place for the ones that are arguable or irrelevant. Children place them and then defend the placement, which is the part that does the work.

**Argue the order aloud.** Groups defend their arrangement and each child justifies one gap: this matters more than this, because.

**Then one paragraph, built on the difference between a Big Point and a Little Point.** The opening sentence answers the question. Everything under it is the evidence. What children have to see is that the first sentence sits at a different level from the rest, and that is worth modelling explicitly rather than assuming.
...
Matched pairs, a labelled picture copied from the board, and short factual answers read as topic work rather than historical thinking, even when every answer is right. Watch the appealing product too: a decorated scroll, a mounted poster, an illustrated diary. It looks like the best work in the unit and evidences presentation.
