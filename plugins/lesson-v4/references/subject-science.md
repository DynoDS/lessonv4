...
Handling is the trigger, and its absence is the boundary. When nobody handles anything - a lesson taught from photographs, video or discussion - no safety moment is required, and one added anyway costs more than it protects: a warning that outweighs the actual risk in the room (`Electricity can cause serious injury or death` over a slide of photographs) teaches children that safety wording is background noise, which is the opposite of what a real precaution needs from them. Safety wording never takes a sticky knowledge slot, a success criterion or an assessed outcome unless safety is itself the objective; at most, a lesson discussing genuinely hazardous things earns one light line in the script.
