...
**The test is the final task: what does a child who does it well now know and demonstrate, and is that the objective?** Ask it of the end performance, not of the coverage plan, because a lesson can mention a field and still assess one corner of it.
