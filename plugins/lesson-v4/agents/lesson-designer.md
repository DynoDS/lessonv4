...
Plan when each word is introduced, and write it into `vocabularyIntroductions` as one entry per moment: the words introduced there, and the unit it follows. Governed by `preferences.md` → Vocabulary.
