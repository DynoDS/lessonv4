...
Provide the exact question or starting example and a large blank or partly blank representation when completing that representation is part of the model. Leave the part being learned blank or constructable; pre-fill supporting parts that reduce irrelevant load. By the end of the model, children must be able to see the completed result.
